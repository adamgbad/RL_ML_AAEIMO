...
public class AgentRewards
{
    ...
    public void AddNotShooPenalty(TankAgent agent, float timeBetweenShoots, float reward) {
        float calculateReward = reward * timeBetweenShoots / 100;
        if (timeBetweenShoots > 6) {
            if (calculateReward > 0.5) {
